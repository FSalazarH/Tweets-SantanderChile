...
mainAppControllers.controller('vivoController',['$scope','$http',
    ...
    function ($scope, $http) {
        ...
        function getTweetsSentiment(){
            $http({method: 'GET', url:'/queryTweetsCategorySentimentLast24'}).
            success(function(data, status, headers, config){
                var positivo = "";
                var negativo = "";
                var neutral = "";
        ...
        $scope.bubbleChart = function() {
            $http({
                method: 'GET',
                url: '/queryTotalLikesCategoryLast24'
            }).success(function (data, status, headers, config) {
                    ...
                    success(function(data, status, headers, config) {
                        ...
                        function Arbol(treeData) {
                            ...
                            function click(d) {
                                ...
                                $('#radio-todos2').prop("checked", true);
